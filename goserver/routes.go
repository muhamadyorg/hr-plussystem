...
func RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/admins", handleAdmins)
	mux.HandleFunc("/api/admins/", handleAdminByID)
	...
	mux.HandleFunc("/api/groups/", handleGroupByID)
	mux.HandleFunc("/api/groups", handleGroups)
	mux.HandleFunc("/api/employees/", handleEmployeeByID)
	...
	mux.HandleFunc("/api/hikvision/settings", handleHikvisionSettings)
	...
	mux.HandleFunc("/api/telegram/token", handleTelegramToken)
